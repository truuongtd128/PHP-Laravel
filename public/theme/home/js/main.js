(function ($) {
	...
	function updateTotal() {
		...
		var shipping = parseFloat($('.shipping').text().replace(/\./g, '').replace('$', '')) || 0;
		var total = subTotal + shipping;

		$('.sub-total').text(subTotal.toLocaleString('vi-VN') + '$');
	...
	$(document).ready(function() {
		...
		// Xử lý sự kiện khi nhấn nút tăng hoặc giảm số lượng
		...
		// Kiểm tra giá trị khi người dùng thay đổi số lượng
