            ...
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <div class="col-lg-2">
                        <div class="logo">
                            <a href="{{route('home')}}">
                                <img src="{{asset('theme/home/img/logo/logo.png')}}" alt="Brand Logo">
                            </a>
                        </div>
                    </div>
                    <!-- start logo area -->
                                            ...
                                            <ul class="megamenu dropdown">
                                                ...
                                                <li class="megamenu-banners d-none d-lg-block">
                                                    <a href="product-details.html">
                                                        <img src="{{asset('theme/home/img/banner/img1-static-menu.jpg')}}" alt="">
                                                    </a>
                                                </li>
                                                <li class="megamenu-banners d-none d-lg-block">
                                                    <a href="product-details.html">
                                                        <img src="{{asset('theme/home/img/banner/img2-static-menu.jpg')}}" alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
